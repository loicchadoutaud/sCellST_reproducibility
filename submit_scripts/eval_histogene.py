...
from scellst.bench.utils_histogene import eval_histogene
...
all_config_dir = Path("/cluster/CBIO/home/lchadoutaud1/code/CellST/models/HisToGene")
        ...
        for organ in benchmark_organs:
            for config_dir in list(all_config_dir.glob(f"*{organ}*")):
                for visium_slide in visium_slides[organ]:
                    ...
                    executor.submit(eval_histogene, config_dir, additional_kwargs)
