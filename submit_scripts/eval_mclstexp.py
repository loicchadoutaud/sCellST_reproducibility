...
all_config_dir = Path("/cluster/CBIO/home/lchadoutaud1/code/CellST/models/MclSTExp")
        ...
        for organ in benchmark_organs:
            for config_dir in list(all_config_dir.glob(f"*{organ}*")):
                for visium_slide in visium_slides[organ]:
                    ...
                    executor.submit(eval_mclstexp, config_dir, additional_kwargs)
