...
from scellst.bench.utils_istar import eval_istar
...
all_config_dir = Path("/cluster/CBIO/home/lchadoutaud1/code/CellST/models/istar")
        ...
        for organ in benchmark_organs:
            for config_dir in list(all_config_dir.glob(f"*{organ}*")):
                for visium_slide in visium_slides[organ]:
                    ...
                    executor.submit(eval_istar, config_dir, additional_kwargs)
